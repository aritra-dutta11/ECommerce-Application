...
export const getSingleProductController = async (req, res) => {
    try {
        ...
        res.status(500).send({
            success: false,
            error,
            message: 'Error in getting the producct'
        })
    }
}

//get photo
export const productPhotoContorller = async (req, res) => {
    try {
...
export const filterProductController = async (req, res) => {
    try {
        ...
        res.status(500).send({
            success: false,
            message: 'Cannot Filter, Something Wrong',
            error,
        })
    }
}
...
export const searchProductController = async (req, res) => {
    try {
        ...
        res.status(500).send({
            success: false,
            message: 'Something is wrong in searching',
            error,
        })
    }
}
...
export const productWiseCategoryController = async (req, res) => {
    try {
        ...
        res.status(500).send({
            success: false,
            message: 'Cound not get category wise products',
            error,
        })
    }
}
